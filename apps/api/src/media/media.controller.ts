...
export class MediaController {
  ...
  async requirements(@CurrentUser() user: AuthUser, @Query('entityType') entityType: PhotoEntityType) {
    return { data: await this.mediaService.requirements(this.tenants.requireTenantId(user), entityType) };
  }
